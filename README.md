...
NOTE: PlayProtect show the warning on some of devices when installing the current apk. The detailed specification of PlayProtect is not public so we cannot address this matter. Please ignore the dialog for now. If you cannot install this apk without any error message, please disable PlayProtect from PlayStore's menus. Sorry for your inconvenience.
