/*
 * If this PR merged, We will use it. https://github.com/Kotlin/kotlinx.coroutines/pull/523/files
 ...
 */
@Suppress("EXPERIMENTAL_API_USAGE") fun <T> Deferred<T>.asTask(): Task<T> {
